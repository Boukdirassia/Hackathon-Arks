...
const LoginPage = () => {
  ...
  // Animation variants - Style simplifié cohérent avec la RegisterPage
        ...
        <div className="max-w-md w-full">
          ...
          <motion.div className="text-center mb-16" variants={itemVariants}>
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                Welcome to <span className="bg-gradient-to-r from-red-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">MoBoe</span>
              </motion.h1>
              <motion.p
              ...
              >
                Continue your <span className="text-red-400 font-semibold">cinematic</span> journey
              </motion.p>
              <motion.div
                ...
                <div className="relative z-10">
                  ...
                  <motion.div className="text-center mt-8" variants={itemVariants}>
                    <p className="text-gray-400">
                      ...
                      <Link to="/auth/register" className="text-red-400 hover:text-red-300 font-medium transition-colors">
                        Sign up
                      </Link>
                    </p>
                  </motion.div>
